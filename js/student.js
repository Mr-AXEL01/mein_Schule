    ...
    loadStudentTable() {
        ...
        if (studentTable) {
            ...
            this.students.forEach(student => {
                ...
                row.innerHTML = `
                    <td class="clickable px-4 py-2">${student.id}</td>
                    <td class="clickable px-4 py-2">${student.name}</td>
                    <td class="clickable px-4 py-2">${student.age}</td>
                    <td class="flex justify-center border gap-4 px-6 py-2">
